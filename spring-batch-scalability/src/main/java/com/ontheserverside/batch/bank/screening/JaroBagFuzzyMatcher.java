...
public final class JaroBagFuzzyMatcher implements FuzzyMatcher {
    ...
    public boolean sequencesMatching(final String phrase1, final String phrase2) {
        final String phrase1LowerCase = phrase1.toLowerCase();
        final String phrase2LowerCase = phrase2.toLowerCase();

        final List<String> phrase1Bag = new ArrayList<>(Arrays.asList(phrase1LowerCase.split(" ")));
        final List<String> phrase2Bag = new ArrayList<>(Arrays.asList(phrase2LowerCase.split(" ")));
